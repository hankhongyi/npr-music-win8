...
namespace NPRNews
{
    ...
    /// </summary>
    public sealed partial class SplitPage : NPRNews.Common.LayoutAwarePage
    {
        public SplitPage()
        {
        ...
        void ItemListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            // opposite effect.
            SampleDataItem selectedItem = (SampleDataItem)itemListView.SelectedItem;
            newsSource.Source = selectedItem.NewsItems;
            if (selectedItem != null)
            {
                Debug.WriteLine("selectedItem-->" + selectedItem.Title);
            }
